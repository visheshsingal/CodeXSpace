...
export default function Pricing() {
  ...
  return (
    <div>
      <FadeOnScroll>
        <TitleDark
          category="Invest in Your Future"
          title="Learn Web Development the Right Way"
          description={`build real-world websites from scratch.\n Get hands-on guidance, code reviews, and join a supportive developer community.`}
            ...
            <FadeOnScroll key={index} delay={index * 0.3}>
              ...
              >
                ...
                <div className="px-8">
                  ...
                  <a href="tel:+919024939664">
                    <Button
                      text="Book A Call"
                      className="mx-2 border border-primary bg-transparent py-4 font-[400] text-white"
                    />
                    </a>
                    <a href={card.paymentLink} target="_blank" rel="noopener noreferrer">
                    <Button
                      text="Click to buy"
