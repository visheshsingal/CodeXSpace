      ...
      <div className="mx-12 flex flex-col items-center justify-evenly overflow-hidden py-16 text-start lg:flex-row lg:gap-20">
        <FadeLeft>
          <div className="flex flex-col lg:w-[606px]">
            ...
            The web development course that connects you to your dream career
            </h1>
          </div>
        </FadeLeft>
        <FadeRight>
          <div className="flex translate-y-8 flex-col md:pb-16 lg:max-w-[536px] lg:translate-y-20">
            ...
            A membership with CodeXSpace eliminates the overwhelm of figuring out where to start with web development.
            We’re here to ensure that your journey to becoming a top-tier developer is seamless and impactful.
            </p>
            <a href="#pricing">
