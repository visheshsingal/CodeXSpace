    ...
    <div>
      ...
      >
        <div>
          ...
          <br /> premium resources, and community support.
          </p>
          ...
          <div className="flex flex-col justify-between gap-10 md:flex-row">
            <div className="flex-col">
              ...
              <FadeOnScroll delay={0.2}>
                ...
                CodeXSpace – a leading web development platform empowering future developers worldwide, from beginners to budding professionals.
                </p>
              </FadeOnScroll>
            </div>
      ...
      <div className="mx-8 flex flex-col justify-between gap-10 py-8 font-light text-white md:flex-row">
        ...
        <FadeOnScroll delay={0.6}>
          <a href="mailto:vishesh.singal.contact@gmail.com">
            © CodeXSpace - All Right Reserved
          </a>
        </FadeOnScroll>
      </div>
    </div>
