      ...
      <div className="mx-12 flex flex-col items-center justify-evenly lg:flex-row lg:gap-20">
        <AnimationComponentLeft>
          <div className="flex flex-col lg:w-[606px]">
            ...
            Your journey from beginner to developer — simplified.
            One platform. One plan. Everything you need.
            </h1>
          </div>
        </AnimationComponentLeft>
        <AnimationComponentRight>
          <div className="flex translate-y-8 flex-col lg:max-w-[500px]">
            ...
            Build your dev career with expert-led courses and real-world projects.
            Learn from industry pros. Access premium resources. One subscription. Unlimited learning.
            </p>
            <a href="#pricing">
